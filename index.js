...
const bannerMessage = `/* eslint-disable unicorn/filename-case, @typescript-eslint/no-empty-interface */
/* This file is automatically generated.
Please do not change this file! */`;

const vueImport = `// noinspection ES6UnusedImports
import Vue from 'vue';`;

const vueAugmentation = `declare module 'vue/types/vue' {
  interface Vue {
    // Augmentation to allow css-modules in .vue files:
    $style: Readonly<CssExports>
  }
}`;
